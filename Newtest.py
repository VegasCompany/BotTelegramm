...
def inputFiles(bot, update):
    chat_id = update.message.chat_id

    update.message.reply_text('Держи, не жалко !')
    telegram.InputFile(data('download/text.txt'))


# @bot.message_handler(content_types=["text"])
# def any_msg(message):
#     keyboard = types.InlineKeyboardMarkup()
#     switch_button = types.InlineKeyboardButton(text="Жмякай", switch_inline_query="Telegram")
...
def main():
    ...
    bot.add_handler(CommandHandler("inputFiles", inputFiles))
